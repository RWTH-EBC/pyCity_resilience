...
# -*- coding: utf-8 -*-
"""
Script to generate test city with 2 buildings and boiler supply
"""
...
def main():  # pragma: no cover
    ...
    save_filename = 'city_2_build_with_esys.pkl'
    save_path = os.path.join(path_workspace,
                             'city_objects',
                             'with_esys',
                             save_filename)
    ...
    log_path = os.path.join(path_workspace,
                            'city_objects',
                            'with_esys',
                            'city_2_build_log.txt')
